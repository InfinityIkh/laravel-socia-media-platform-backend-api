...
Route::middleware(['auth:api','throttle:api'])->group(function(){
    ...
    //HashTags
    Route::get('/posts/{hashtag}',[HashTagsController::class,'posts']);
    //reports
    Route::post('/users/report/{user}',[UserController::class,'report']);
    Route::post('/posts/report/{post}',[PostController::class,'report']);
    //blocks
    Route::post('/users/block/{user}',[UserController::class,'block']);
    Route::get('/users/blocked_users',[UserController::class,'blocked_users']);
    //follow_requests
    Route::post('/users/follow/{user}',[FollowRequestController::class,'follow']);
    ...
    Route::get('stories/viewers/{story}',[StoryController::class,'storyViewers']);
    //Conversations
    Route::get('/conversations', [ConversationController::class, 'index']);
    Route::post('/conversations', [ConversationController::class, 'store']);
    Route::get('/conversations/{conversation}', [ConversationController::class, 'show']);
    Route::post('/conversations/leave/{conversation}', [ConversationController::class, 'leave']);
    Route::delete('/conversations/{conversation}', [ConversationController::class, 'destroy']);
    //Messages
    Route::get('/conversations/messages{conversation}', [MessagesController::class, 'index']);
    Route::post('/conversations/messages/{conversation}', [MessagesController::class, 'store']);
    Route::patch('/messages/read/{message}', [MessagesController::class, 'markAsRead']);
